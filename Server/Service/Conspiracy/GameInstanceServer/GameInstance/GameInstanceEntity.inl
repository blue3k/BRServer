...
{
	m_GamePlayerByPlayerID.ForeachOrder(0, GameLogItem::LEGACY_MAX_GAMEPLAYER, [&](const PlayerID& playerID, Svr::GameInstancePlayer* pPlayer)-> bool
	{
...
{
	m_GamePlayerByPlayerID.ForeachOrder(0, GameLogItem::LEGACY_MAX_GAMEPLAYER, [&](const PlayerID& playerID, Svr::GameInstancePlayer* pGameInsPlayer)-> bool
	{
