...
namespace BR
{
 	namespace Svr
	{
 		class ServerService : public ServerServiceBase
		{
			...
			Result ServerConnectedC2SEvt( const EntityID &InSenderEntityID, const ServiceInformation &InClusterManagerServiceInformation, const UINT32 &InStartUpTime, const NetAddress &InPrivateAddress );
