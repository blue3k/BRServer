...
namespace BR
{
 	namespace Svr
	{
		...
		Result ServerService::ServerConnectedC2SEvt( const EntityID &InSenderEntityID, const ServiceInformation &InClusterManagerServiceInformation, const UINT32 &InStartUpTime, const NetAddress &InPrivateAddress )
		{
 			Result hr;
