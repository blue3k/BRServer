...
namespace SF
{
	...
	private:
		...
		String GetLeapNodeName(const String& nodePath);
		...
		Result ParseServerComponent(const String& nodePath, const Json::Value& json, ServerConfig::ServerComponent* &pServerComponent);
		...
		Result LoadGameInstanceServer(const String& nodePath, ServerConfig::GameInstanceServer* &pServer);
		Result LoadGameServer(const String& nodePath, ServerConfig::GameServer* &pServer);
		Result LoadModuleServer(const String& nodePath, ServerConfig::ModuleServer* &pServer);
		Result LoadDBClusters(const String& rootPath, Array<ServerConfig::DBCluster*>& dbClusters);
		Result LoadModuleServers(const String& rootPath, Array<ServerConfig::ModuleServer*>& servers);
		Result LoadGameCluster(GameID gameClusterID, const String& nodePath, ServerConfig::GameCluster* &pGameCluster);
	...
	public:
		...
		// MemoryManager
		IMemoryManager& GetMemoryManager() { return m_Config.GetMemoryManager(); }
