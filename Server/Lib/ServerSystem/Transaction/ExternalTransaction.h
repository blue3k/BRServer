...
namespace Svr{
	...
	public:
		...
		HTTPExternalTransaction(IHeap& memMgr, TransactionID parentTransID, Message::MessageID MsgID);
	...
	public:
		...
		// Constructor
		GCMHttpExternalTransaction(IHeap& memMgr);
	...
	public:
		...
		// Constructor
		ExternalTransactionGoogleAndroidReceiptCheck(IHeap& memMgr, TransactionID parentTransID, Google::OAuth* pOAuth);
	...
	public:
		...
		// Constructor
		ExternalTransactionIOSRecepitCheck(IHeap& memMgr, TransactionID parentTransID, const char* strURL, const char* strAltURL);
