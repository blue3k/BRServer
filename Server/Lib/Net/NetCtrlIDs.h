...
namespace Net {
	...
	static const Message::MessageID PACKET_NETCTRL_ACK				= Message::MessageID(Message::MSGTYPE_NETCONTROL, Message::MSGTYPE_NONE,	 Message::MSGTYPE_MOBILE, POLICY_NONE, NetCtrlCode_Ack);
	static const Message::MessageID PACKET_NETCTRL_NACK				= Message::MessageID(Message::MSGTYPE_NETCONTROL, Message::MSGTYPE_NONE,	 Message::MSGTYPE_MOBILE, POLICY_NONE, NetCtrlCode_Nack);
	static const Message::MessageID PACKET_NETCTRL_HEARTBIT			= Message::MessageID(Message::MSGTYPE_NETCONTROL, Message::MSGTYPE_NONE,	 Message::MSGTYPE_MOBILE, POLICY_NONE, NetCtrlCode_HeartBit);
	static const Message::MessageID PACKET_NETCTRL_DISCONNECT		= Message::MessageID(Message::MSGTYPE_NETCONTROL, Message::MSGTYPE_NONE,	 Message::MSGTYPE_MOBILE, POLICY_NONE, NetCtrlCode_Disconnect);
	static const Message::MessageID PACKET_NETCTRL_CONNECT			= Message::MessageID(Message::MSGTYPE_NETCONTROL, Message::MSGTYPE_NONE,	 Message::MSGTYPE_MOBILE, POLICY_NONE, NetCtrlCode_Connect);
	static const Message::MessageID PACKET_NETCTRL_CONNECTPEER		= Message::MessageID(Message::MSGTYPE_NETCONTROL, Message::MSGTYPE_NONE,	 Message::MSGTYPE_MOBILE, POLICY_NONE, NetCtrlCode_ConnectPeer);
