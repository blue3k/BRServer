...
namespace DB {
	...
	public:
		...
		// Add game log
		HRESULT AddGameLog(UINT shardID, const PlayerID &playerID, ULONG gameTime, TransLogCategory LogCategory, INT consume, INT gain, UINT64 totalValue, const char* logMessage);
