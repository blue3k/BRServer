...
namespace SF
{
 	class GameServerService : public ServerServiceBase
	{
		...
		Result RegisterPlayerToJoinGameServerCmd( const uint64_t &InTransactionID, const PlayerID &InPlayerID, const AuthTicket &InTicket, const FacebookUID &InFBUserID, const uint32_t &InShardID );
		...
		Result RegisterPlayerToJoinGameServerOnPlayerEntityCmd( const uint64_t &InTransactionID, const PlayerID &InPlayerID, const AuthTicket &InTicket, const FacebookUID &InFBUserID );
