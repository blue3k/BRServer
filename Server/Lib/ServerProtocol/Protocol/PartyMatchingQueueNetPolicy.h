...
namespace SF
{
   ...
   struct ActorMovement;
	...
	class NetPolicyPartyMatchingQueue 
	{
		...
		public:
		// Constructor
		NetPolicyPartyMatchingQueue (const SharedPointerT<MessageEndpoint>& pEndpoint ) : m_Endpoint(pEndpoint)
		{}
	...
	class NetSvrPolicyPartyMatchingQueue
	{
		...
		public:
		// Constructor
		NetSvrPolicyPartyMatchingQueue ( const SharedPointerT<MessageEndpoint>& pEndpoint ) : m_Endpoint(pEndpoint)
		{}
