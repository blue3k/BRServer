...
namespace SF
{
   ...
   struct ActorMovement;
	...
	class NetPolicyGameServer 
	{
		...
		public:
		// Constructor
		NetPolicyGameServer (const SharedPointerT<MessageEndpoint>& pEndpoint ) : m_Endpoint(pEndpoint)
		{}
	...
	class NetSvrPolicyGameServer
	{
		...
		public:
		// Constructor
		NetSvrPolicyGameServer ( const SharedPointerT<MessageEndpoint>& pEndpoint ) : m_Endpoint(pEndpoint)
		{}
