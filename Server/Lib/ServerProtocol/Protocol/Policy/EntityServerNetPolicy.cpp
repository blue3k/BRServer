...
namespace SF
{
 	namespace Policy
	{
		...
		// Cmd: Find Entity
		Result NetPolicyEntityServer::UnregisterEntityCmd( const TransactionID &InTransactionID, const uint64_t &InEntUID )
		{
 			Result hr;
		...
		// Cmd: Register entity
		Result NetSvrPolicyEntityServer::RegisterEntityRes( const TransactionID &InTransactionID, const Result &InResult, const uint64_t &InEntUID )
		{
 			Result hr;
		...
		// Cmd: Find Entity
		Result NetSvrPolicyEntityServer::FindEntityRes( const TransactionID &InTransactionID, const Result &InResult, const uint64_t &InEntUID )
		{
 			Result hr;
