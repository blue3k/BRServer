...
namespace SF
{
 	namespace Policy
	{
		...
		class NetSvrPolicyChatChannel
		{
			...
			// Cmd: Request to join chat channel
			Result JoinRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const Result &InResult, const PlayerID &InChatChannelLeaderID );
			...
			// Cmd: Leave chat channel
			Result LeaveRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const Result &InResult );
