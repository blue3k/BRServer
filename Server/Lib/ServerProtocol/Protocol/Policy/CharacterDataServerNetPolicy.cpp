...
namespace SF
{
 	namespace Policy
	{
		...
		Result NetPolicyCharacterDataServer::AddCharacterDataCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const char* InCharacterName, const VariableTable &InAttributes )
		{
 			FunctionContext hr;
			 ...
			 pMessage = SF::Message::CharacterDataServer::AddCharacterDataCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName, InAttributes);
		...
		Result NetPolicyCharacterDataServer::RemoveCharacterDataCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName )
		{
 			FunctionContext hr;
			 ...
			 pMessage = SF::Message::CharacterDataServer::RemoveCharacterDataCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName);
			 protocolCheckPtr(*pMessage);
		...
		Result NetPolicyCharacterDataServer::GetCharacterDataListCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName )
		{
 			FunctionContext hr;
			 ...
			 pMessage = SF::Message::CharacterDataServer::GetCharacterDataListCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName);
			 protocolCheckPtr(*pMessage);
		...
		Result NetPolicyCharacterDataServer::GetCharacterDataCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName )
		{
 			FunctionContext hr;
			 ...
			 pMessage = SF::Message::CharacterDataServer::GetCharacterDataCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName);
			 protocolCheckPtr(*pMessage);
		...
		Result NetPolicyCharacterDataServer::SetAttributeCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName, const VariableTable &InAttributes )
		{
 			FunctionContext hr;
			 ...
			 pMessage = SF::Message::CharacterDataServer::SetAttributeCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName, InAttributes);
			 protocolCheckPtr(*pMessage);
		...
		Result NetPolicyCharacterDataServer::RemoveAttributesCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName, const Array<StringCrc32>& InAttributeNames )
		{
			 ...
			 pMessage = SF::Message::CharacterDataServer::RemoveAttributesCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName, InAttributeNames);
			 protocolCheckPtr(*pMessage);
		...
		Result NetPolicyCharacterDataServer::AttributeValueAddCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName, const StringCrc32 &InAttributeName, const float &InValue )
		{
			 ...
			 pMessage = SF::Message::CharacterDataServer::AttributeValueAddCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName, InAttributeName, InValue);
			 protocolCheckPtr(*pMessage);
		...
		Result NetPolicyCharacterDataServer::AttributeValueSubCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName, const StringCrc32 &InAttributeName, const float &InValue )
		{
			 ...
			 pMessage = SF::Message::CharacterDataServer::AttributeValueSubCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName, InAttributeName, InValue);
			 protocolCheckPtr(*pMessage);
		...
		Result NetPolicyCharacterDataServer::AttributeValueCASCmd( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const uint16_t &InRouteHopCount, const PlayerID &InPlayerID, const StringCrc32 &InCharacterName, const StringCrc32 &InAttributeName, const StringCrc32 &InAttributeType, const uint64_t &InExpected, const uint64_t &InNewValue )
		{
			 ...
			 pMessage = SF::Message::CharacterDataServer::AttributeValueCASCmd::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InRouteHopCount, InPlayerID, InCharacterName, InAttributeName, InAttributeType, InExpected, InNewValue);
			 protocolCheckPtr(*pMessage);
		...
		// Cmd: Add character data to the account
		Result NetSvrPolicyCharacterDataServer::AddCharacterDataRes( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const Result &InResult, const uint64_t &InCharacterUID )
		{
 			FunctionContext hr;
			 ...
			 pMessage = SF::Message::CharacterDataServer::AddCharacterDataRes::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InResult, InCharacterUID);
			 protocolCheckPtr(*pMessage);
		...
		// Cmd: Get character list
		Result NetSvrPolicyCharacterDataServer::GetCharacterDataListRes( const RouteContext &InRouteContext, const uint64_t &InTransactionID, const Result &InResult, const StringCrc32 &InCharacterName, const VariableTable &InAttributes )
		{
 			FunctionContext hr;
			 ...
			 pMessage = SF::Message::CharacterDataServer::GetCharacterDataListRes::Create(m_pConnection->GetIOHeap(), InRouteContext, InTransactionID, InResult, InCharacterName, InAttributes);
			 protocolCheckPtr(*pMessage);
