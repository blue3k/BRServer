...
namespace SF
{
 	namespace Protocol
	{
		...
		void RegisterParserGamePartyManager()
		{
			...
			MessageParseToVariableMap.insert(std::make_pair(Message::GamePartyManager::CreatePartyCmd::MID.IDSeq.MsgID,&Message::GamePartyManager::CreatePartyCmd::ParseMessageTo));
			...
			MessageParseToVariableMap.insert(std::make_pair(Message::GamePartyManager::CreatePartyRes::MID.IDSeq.MsgID,&Message::GamePartyManager::CreatePartyRes::ParseMessageTo));
			...
			MessageParseToVariableMap.insert(std::make_pair(Message::GamePartyManager::PartyDeletedC2SEvt::MID.IDSeq.MsgID,&Message::GamePartyManager::PartyDeletedC2SEvt::ParseMessageTo));
