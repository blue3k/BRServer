...
namespace BR
{
 	namespace Policy
	{
 		class NetPolicyGameInstance : public IPolicyGameInstance
		{
			...
			// Cmd: Join Game
			HRESULT JoinGameCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerInformation &InPlayer, const AuthTicket &InTicket, const PlayerRole &InRequestedRole );
			// C2S: Change configue preset
			HRESULT SetConfigPresetC2SEvt( const RouteContext &InRouteContext, const UINT32 &InPresetID );
			// Cmd: Leave Game
			HRESULT LeaveGameCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID );
			// Cmd: Kick player
			HRESULT KickPlayerCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID, const PlayerID &InPlayerToKick );
			// Cmd: Assign role
			HRESULT AssignRoleCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID );
			...
			// Cmd: Advance game
			HRESULT AdvanceGameCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID );
			// Cmd: *Vote game advance
			HRESULT VoteGameAdvanceCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID );
			// Cmd: Assign role
			HRESULT VoteCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID, const PlayerID &InVoteTarget, const UINT32 &InActionSerial );
			// Cmd: Play again with the current players
			HRESULT GamePlayAgainCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InLeadPlayer, const PartyUID &InPartyUID );
			// Cmd: Player. revive himself
			HRESULT GameRevealPlayerCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID, const Array<PlayerID>& InTargetPlayerID );
			// Cmd: Player. revive himself
			HRESULT GamePlayerReviveCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID );
		...
		class NetSvrPolicyGameInstance : public ISvrPolicyGameInstance
		{
			...
			// Cmd: Leave Game
			HRESULT LeaveGameRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
			// S2C: Player left
			...
			// Cmd: Assign role
			HRESULT AssignRoleRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
			// S2C: Assign role
			HRESULT RoleAssignedS2CEvt( const RouteContext &InRouteContext, const PlayerRole &InRole );
			// Cmd: Advance game
			HRESULT AdvanceGameRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
			...
			// Cmd: *Vote game advance
			HRESULT VoteGameAdvanceRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
			// S2C: *GameAdvance is Voted
			HRESULT GameAdvanceVotedS2CEvt( const RouteContext &InRouteContext, const PlayerID &InVoter );
			// Cmd: Assign role
			HRESULT VoteRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
			// S2C: Player Voted
			...
			// Cmd: Play again with the current players
			HRESULT GamePlayAgainRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext, const UINT32 &InReplayMemberCount );
			...
			// Cmd: Player. revive himself
			HRESULT GameRevealPlayerRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext, const Array<PlayerID>& InRevealedPlayerID, const Array<PlayerRole>& InRevealedRole );
			// Cmd: Player. revive himself
			HRESULT GamePlayerReviveRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
