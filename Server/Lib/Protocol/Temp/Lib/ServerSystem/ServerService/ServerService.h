...
namespace BR
{
 	namespace Svr
	{
 		class ServerService : public ServerServiceBase
		{
			...
			HRESULT ServerConnectedC2SEvt( const EntityID &InSenderEntityID, const ServiceInformation &InClusterManagerServiceInformation, const UINT64 &InStartUpTime, const NetAddress &InPublicAddress, const NetAddress &InPrivateAddress );
