...
namespace BR
{
 	namespace Policy
	{
 		class NetPolicyClusterServer : public IPolicyClusterServer
		{
			...
			HRESULT RequestDataSyncCmd( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const UINT16 &InRouteHopCount, const ClusterID &InClusterID );
			// C2S: Master vote
			...
			HRESULT GetLowestWorkloadClusterMemberCmd( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const UINT16 &InRouteHopCount, const ClusterID &InClusterID );
		...
		class NetSvrPolicyClusterServer : public ISvrPolicyClusterServer
		{
			...
			// Cmd: Cluster member list query
			HRESULT GetClusterMemberListRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult, const Array<ServiceInformation>& InMemberList );
			// Cmd: Join to the cluster, This operation will be manually broadcasted and gathered the result
			HRESULT JoinClusterRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult, const Array<ServiceInformation>& InMemberList );
			// Cmd: Join to the cluster
			HRESULT RequestDataSyncRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult );
			...
			// Cmd: Get lowest workloaded cluster member
			HRESULT GetLowestWorkloadClusterMemberRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult, const ServiceInformation &InMember );
