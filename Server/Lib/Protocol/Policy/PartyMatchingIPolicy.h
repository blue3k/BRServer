...
namespace BR
{
 	namespace Policy
	{
		...
		class ISvrPolicyPartyMatching : public Net::INetPolicy
		{
			...
			// S2C: 
			virtual Result PartyGameMatchedS2CEvt( const RouteContext &InRouteContext, const UINT16 &InRouteHopCount ) = 0;
			// S2C: 
			virtual Result PlayerGameMatchedS2CEvt( const RouteContext &InRouteContext, const UINT16 &InRouteHopCount, const PlayerID &InDestPlayerID, const GameInsUID &InGameInsUID, const PlayerRole &InRequestedRole ) = 0;
