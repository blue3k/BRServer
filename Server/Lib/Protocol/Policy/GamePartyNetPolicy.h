...
namespace BR
{
 	namespace Policy
	{
 		class NetPolicyGameParty : public IPolicyGameParty
		{
			...
			// Cmd: Join Party
			HRESULT JoinPartyCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InInviterID, const PlayerInformation &InInvitedPlayer );
			// Cmd: Kick player
			HRESULT LeavePartyCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID );
			// Cmd: Kick player
			...
			// Cmd: Match
			HRESULT StartGameMatchCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID, const UINT32 &InMaxGamePlayers );
			// Cmd: Match
			HRESULT CancelGameMatchCmd( const Context &InContext, const RouteContext &InRouteContext, const PlayerID &InPlayerID );
		...
		class NetSvrPolicyGameParty : public ISvrPolicyGameParty
		{
			...
			// Cmd: Join Party
			HRESULT JoinPartyRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext, const PlayerID &InPartyLeaderID, const Array<BYTE>& InChatHistoryData );
			// S2C: Player Joined
			...
			// Cmd: Kick player
			HRESULT LeavePartyRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
			// S2C: Player left
			...
			// Cmd: Match
			HRESULT StartGameMatchRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
			...
			// Cmd: Match
			HRESULT CancelGameMatchRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext );
