...
namespace BR
{
 	namespace Policy
	{
 		class NetPolicyGameParty : public IPolicyGameParty
		{
			...
			// Cmd: Join Party
			HRESULT JoinPartyCmd( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const PlayerID &InInviterID, const PlayerInformation &InInvitedPlayer );
			// Cmd: Kick player
			HRESULT LeavePartyCmd( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const PlayerID &InPlayerID );
			// Cmd: Kick player
			...
			// Cmd: Match
			HRESULT StartGameMatchCmd( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const PlayerID &InPlayerID, const UINT32 &InMaxGamePlayers );
			// Cmd: Match
			HRESULT CancelGameMatchCmd( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const PlayerID &InPlayerID );
		...
		class NetSvrPolicyGameParty : public ISvrPolicyGameParty
		{
			...
			// Cmd: Join Party
			HRESULT JoinPartyRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult, const PlayerID &InPartyLeaderID, const Array<BYTE>& InChatHistoryData );
			// S2C: Player Joined
			...
			// Cmd: Kick player
			HRESULT LeavePartyRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult );
			// S2C: Player left
			...
			// Cmd: Match
			HRESULT StartGameMatchRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult );
			...
			// Cmd: Match
			HRESULT CancelGameMatchRes( const RouteContext &InRouteContext, const TransactionID &InTransactionID, const HRESULT &InResult );
