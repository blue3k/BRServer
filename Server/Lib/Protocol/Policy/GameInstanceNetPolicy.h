...
namespace BR
{
 	namespace Policy
	{
 		class NetPolicyGameInstance : public IPolicyGameInstance
		{
			...
			// Cmd: Join Game
			HRESULT JoinGameCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerInformation &InPlayer, const AuthTicket &InTicket, const PlayerRole &InRequestedRole );
			// C2S: Change configue preset
			HRESULT SetConfigPresetC2SEvt( const RouteContext &InRouteContext, const UINT32 &InPresetID );
			// Cmd: Leave Game
			HRESULT LeaveGameCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InPlayerID );
			// Cmd: Kick player
			...
			// Cmd: Assign role
			HRESULT AssignRoleCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InPlayerID );
			...
			// Cmd: Advance game
			HRESULT AdvanceGameCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InPlayerID );
			// Cmd: *Vote game advance
			HRESULT VoteGameAdvanceCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InPlayerID );
			// Cmd: Assign role
			HRESULT VoteCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InPlayerID, const PlayerID &InVoteTarget, const UINT32 &InActionSerial );
			// Cmd: Play again with the current players
			HRESULT GamePlayAgainCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InLeadPlayer, const PartyUID &InPartyUID );
			// Cmd: Player. revive himself
			HRESULT GameRevealPlayerCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InPlayerID, const Array<PlayerID>& InTargetPlayerID );
			// Cmd: Player. revive himself
			HRESULT GamePlayerReviveCmd( const RouteContext &InRouteContext, const Context &InContext, const PlayerID &InPlayerID );
		...
		class NetSvrPolicyGameInstance : public ISvrPolicyGameInstance
		{
			...
			// Cmd: Leave Game
			HRESULT LeaveGameRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult );
			// S2C: Player left
			...
			// Cmd: Assign role
			HRESULT AssignRoleRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult );
			// S2C: Assign role
			HRESULT RoleAssignedS2CEvt( const RouteContext &InRouteContext, const PlayerRole &InRole );
			// Cmd: Advance game
			HRESULT AdvanceGameRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult );
			...
			// Cmd: *Vote game advance
			HRESULT VoteGameAdvanceRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult );
			// S2C: *GameAdvance is Voted
			HRESULT GameAdvanceVotedS2CEvt( const RouteContext &InRouteContext, const PlayerID &InVoter );
			// Cmd: Assign role
			HRESULT VoteRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult );
			// S2C: Player Voted
			...
			// Cmd: Play again with the current players
			HRESULT GamePlayAgainRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult, const UINT32 &InReplayMemberCount );
			...
			// Cmd: Player. revive himself
			HRESULT GameRevealPlayerRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult, const Array<PlayerID>& InRevealedPlayerID, const Array<PlayerRole>& InRevealedRole );
			// Cmd: Player. revive himself
			HRESULT GamePlayerReviveRes( const RouteContext &InRouteContext, const Context &InContext, const HRESULT &InResult );
