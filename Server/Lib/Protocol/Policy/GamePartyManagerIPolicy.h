...
namespace BR
{
 	namespace Policy
	{
		...
		class ISvrPolicyGamePartyManager : public Net::INetPolicy
		{
			...
			virtual HRESULT CreatePartyRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext ) = 0;
		...
		class IPolicyGamePartyManager : public Net::INetPolicy
		{
			...
			// Cmd: Create a party instance
			virtual HRESULT CreatePartyCmd( const Context &InContext, const RouteContext &InRouteContext, const UINT16 &InRouteHopCount, const PlayerInformation &InCreator ) = 0;
			// C2S: Party instance notify of deletion
