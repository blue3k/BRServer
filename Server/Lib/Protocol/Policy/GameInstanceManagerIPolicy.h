...
namespace BR
{
 	namespace Policy
	{
		...
		class ISvrPolicyGameInstanceManager : public Net::INetPolicy
		{
			...
			virtual HRESULT CreateGameRes( const Context &InContext, const HRESULT &InResult, const RouteContext &InRouteContext ) = 0;
		...
		class IPolicyGameInstanceManager : public Net::INetPolicy
		{
			...
			// Cmd: Create a game instance
			virtual HRESULT CreateGameCmd( const Context &InContext, const RouteContext &InRouteContext, const UINT16 &InRouteHopCount, const UINT16 &InNumberOfBotPlayer, const UINT16 &InMaxPlayer ) = 0;
			// C2S: Game instance notify of deletion
