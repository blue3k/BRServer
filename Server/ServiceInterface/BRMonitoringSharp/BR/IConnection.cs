...
public class IConnection : SharedObject {
  ...
  public unsafe uint GetCID() {
    uint ret = BRMonitoringPINVOKE.IConnection_GetCID(swigCPtr);
    return ret;
  }
  ...
  public unsafe uint GetUData() {
    uint ret = BRMonitoringPINVOKE.IConnection_GetUData(swigCPtr);
    return ret;
  }

  public unsafe void SetUData(uint UData) {
    BRMonitoringPINVOKE.IConnection_SetUData(swigCPtr, UData);
  }
