...
public class MatchingPlayerInformation : global::System.IDisposable {
  ...
  public unsafe PlayerRole RequestedRole {
    set {
      BRMonitoringPINVOKE.MatchingPlayerInformation_RequestedRole_set(swigCPtr, (int)value);
    } 
    get {
      PlayerRole ret = (PlayerRole)BRMonitoringPINVOKE.MatchingPlayerInformation_RequestedRole_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public unsafe MatchingPlayerInformation(EntityUID playerUID, ulong playerID, PlayerRole requestedRole) : this(BRMonitoringPINVOKE.new_MatchingPlayerInformation__SWIG_2(EntityUID.getCPtr(playerUID), playerID, (int)requestedRole), true) {
    if (BRMonitoringPINVOKE.SWIGPendingException.Pending) throw BRMonitoringPINVOKE.SWIGPendingException.Retrieve();
  }
