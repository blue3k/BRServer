...
--
-- Dumping routines for database 'dbconspiracy00'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spGetPlayerInfo`(
...
BEGIN
	...
	select Grade, Level, Exp, Money, Gem, Stamina, TotalPlayed, WinPlaySC, WinPlaySM, LosePlaySC, LosePlaySM, WinPlayNC, WinPlayNM, LosePlayNC, LosePlayNM
