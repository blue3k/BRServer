...
namespace BRTest
{
	...
	TEST_F(HashTableTest, HashTable2_NonUnique)
	{
		...
		typedef BR::Hash::HashTable2<	INT64, TestMapNode2*,
			BR::Hash::NonUniqueKeyTrait, BR::ThreadSyncTraitNoneT<INT64, TestMapNode2*>
		> TestTableType;
	...
	{
		typedef BR::Hash::HashTable2<	INT64, TestMapNode2*,
			BR::Hash::UniqueKeyTrait, BR::ThreadSyncTraitNoneT<INT64, TestMapNode2*>
		> TestTableType;
	...
	TEST_F(HashTableTest, HashTable2_UniqueMT)
	{
		...
		typedef BR::Hash::HashTable2<	INT64, SharedPointerT<TestMapNodeShared>,
			BR::Hash::UniqueKeyTrait, BR::ThreadSyncTraitReadWriteT<INT64, SharedPointerT<TestMapNodeShared>>
		> TestTableType;
