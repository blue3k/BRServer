...
robocopy %OPENSSL_DIR%\buildWindows\openssl\bin Server\bin\x64Debug\bin *.dll *.pdb
robocopy %OPENSSL_DIR%\buildWindows\openssl\bin Server\bin\x64RelWithDebInfo\bin *.dll *.pdb
...
set MYSQL_DIR=..\StormForge\3rdParties\src\mysql
robocopy %MYSQL_DIR%\buildWindows\x64\lib64\debug Server\bin\x64Debug\ *.dll *.pdb *.exe
robocopy %MYSQL_DIR%\buildWindows\x64\lib64 Server\bin\x64RelWithDebInfo\ *.dll *.pdb *.exe
robocopy %MYSQL_DIR%\buildWindows\x64\lib64\debug buildWindows\x64\TestApp\UnitTest\Debug\ *.dll *.pdb *.exe
robocopy %MYSQL_DIR%\buildWindows\x64\lib64 buildWindows\x64\TestApp\UnitTest\Release\ *.dll *.pdb *.exe
