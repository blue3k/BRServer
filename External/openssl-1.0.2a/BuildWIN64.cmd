...
call perl Configure VC-WIN64A no-asm --openssldir=%OPENSSLDIR% --prefix=%PWD%\TargetRelease
call ms\do_win64a
nmake -f ms\nt.mak
nmake -f ms\nt.mak install


call perl Configure debug-VC-WIN64A no-asm -openssldir=%OPENSSLDIR% --prefix=%PWD%\TargetDebug
call ms\do_win64a
nmake -f ms\nt.mak
nmake -f ms\nt.mak install
